...
struct angband_constants
{
	...
	uint16_t store_max;		/**< Maximum number of store types */
	uint16_t themed_max;		/**< Maximum number of themed levels */
	...
	uint16_t dungeon_wid;	/**< Maximum number of horizontal grids per level */
	...
	uint16_t themed_dun;	/* !/Chance of a themed level in the dungeon */
	uint16_t themed_wild;	/* !/Chance of a themed level in the wilderness */
