		...
		int ul_x_win, int ul_y_win)
{
	...
	if (window->index == MAIN_WINDOW) {
		...
		sdlpui_create_menu_button(c, "Reset Panel Slots",
			SDLPUI_HOR_LEFT, handle_menu_reset_slots, 0, SDL_FALSE);
#endif
	}
	c = sdlpui_get_simple_menu_next_unused(result, SDLPUI_MFLG_NONE);
...
static SDL_bool handle_panel_key_mouseclick(struct sdlpui_control *c,
		struct sdlpui_dialog *d, struct sdlpui_window *w,
...
static SDL_bool is_panel_key_disabled(const struct sdlpui_control *c)
{
	const struct panel_key *pk;
...
static SDL_bool set_panel_key_disabled(struct sdlpui_control *c,
		struct sdlpui_dialog *d, struct sdlpui_window *w, SDL_bool disabled)
{
	struct panel_key *pk;
	bool old;
...
static SDL_bool handle_panel_rose_mouseclick(struct sdlpui_control *c,
		struct sdlpui_dialog *d, struct sdlpui_window *w,
		const SDL_MouseButtonEvent *e)
{
	struct panel_rose *pr;
 ...
 */
static SDL_bool handle_panel_rose_mousemove(struct sdlpui_control *c,
		struct sdlpui_dialog *d, struct sdlpui_window *w,
...
static SDL_bool handle_panel_mouseclick(struct sdlpui_dialog *d,
...
static SDL_bool handle_panel_mousemove(struct sdlpui_dialog *d,
